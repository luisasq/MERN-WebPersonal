...
function createCourse(req,res){
    ...
    const imagePah = image.getFilePath(req.files.miniature);
    course.miniature = imagePah;
...
function updateCourse(req,res){
    ...
    if(req.files.miniature){ //valida si el usuario envia una imagen para modificarla sino, no modifica la imagen
